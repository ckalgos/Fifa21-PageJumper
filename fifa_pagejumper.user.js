...
// @version      1.0.1
// @updateURL    https://github.com/ckalgos/Fifa21-PageJumper/blob/master/fifa_pagejumper.user.js
...
(function () {
  ...
  UTMarketSearchResultsViewController.prototype._requestItems = function (l) {
    ...
    this._paginationViewModel.stopAuctionUpdates(),
      services.Item.searchTransferMarket(this._searchCriteria, l).observe(
        this,
          ...
          if (0 < this._searchCriteria.offset && 0 === t.data.items.length)
            ...
            if (
              (!this._stadiumViewmodel ||
                ...
                (r = this._stadiumViewmodel.getStadiumProgression(
